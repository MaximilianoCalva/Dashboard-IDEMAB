...
# Configuration
output_dir = "Dashboard/ReikiTibetano"
modules = ["M1", "M2", "M3", "M4", "M5", "M6"]
api_placeholder = "https://script.google.com/macros/s/AKfycbxjoMxugqhZLCksdQGB90s0HtLHdaw0TEJxsYrSu7VPmAEZyKelUTdFzvgkmKWT84QSYA/exec"
...
template_aula = """
<!-- Snippet: Aula TV {module} - Reiki Tibetano -->
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="mb-12 border-l-4 border-purple-600 pl-6">
        ...
        <p class="text-lg text-gray-500 idemab-font-body">Reiki Tibetano</p>
    </div>
...
template_material = """
<!-- Snippet: Material {module} - Reiki Tibetano -->
<script src="https://cdn.tailwindcss.com"></script>
...
<div class="idemab-material max-w-7xl mx-auto p-4">
    <div class="text-center mb-8">
        ...
        <p class="text-gray-500 mt-1">Recursos del Módulo {module_num} (Reiki Tibetano)</p>
    </div>
...
for mod in modules:
    ...
    # Aula TV
    file_aula = f"{output_dir}/snippet-reiki-{mod.lower()}-aula-tv.html"
    ...
    # Material
    file_mat = f"{output_dir}/snippet-reiki-{mod.lower()}-material.html"

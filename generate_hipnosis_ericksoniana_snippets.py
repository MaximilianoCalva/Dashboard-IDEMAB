...
# Configuration
output_dir = "Dashboard/HipnosisEricksoniana"
modules = [f"M{i}" for i in range(1, 13)] # 12 Modules
# PLACEHOLDER - USER MUST UPDATE THIS
api_placeholder = "https://script.google.com/macros/s/AKfycbysUIY8Z8lbmsE7azjgcucCZMJT76j9l7KAfWBzdzlYOvrp-tdWMZZE5lZ8Rw4vXrn6/exec"
...
# Templates
template_aula = """
<!-- Snippet: Aula TV {module} - Hipnosis Ericksoniana -->
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="mb-12 border-l-4 border-purple-600 pl-6">
        ...
        <p class="text-lg text-gray-500 idemab-font-body">Hipnosis Ericksoniana</p>
    </div>
...
template_material = """
<!-- Snippet: Material {module} - Hipnosis Ericksoniana -->
<script src="https://cdn.tailwindcss.com"></script>
...
<div class="idemab-material max-w-7xl mx-auto p-4">
    <div class="text-center mb-8">
        ...
        <p class="text-gray-500 mt-1">Recursos del Módulo {module_num} (Hipnosis Ericksoniana)</p>
    </div>
...
for mod in modules:
    ...
    # Aula TV
    file_aula = f"{output_dir}/snippet-hipnosis-ericksoniana-{mod.lower()}-aula-tv.html"
    ...
    # Material
    file_mat = f"{output_dir}/snippet-hipnosis-ericksoniana-{mod.lower()}-material.html"

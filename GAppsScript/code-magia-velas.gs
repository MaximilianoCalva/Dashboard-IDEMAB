/**
 * UNIVERSAL SHEET TO JSON API (IDEMAB MAGIA DE LAS VELAS)
 * 
...
function doGet(e) {
    ...
    sheets.forEach(function (sheet) {
        ...
        // Normalize sheet name to handle potential "AulaTV" vs "Aula TV" differences if needed, 
        // but snippet logic relies on exact prefix match usually. 
        // We will assume standard "Aula TV M1" format as per other sheets, 
        // though the screenshot showed "AulaTV M1". Let's handle both in the script or just pass raw.
        // We pass raw, JS client handles fuzzy "startsWith".

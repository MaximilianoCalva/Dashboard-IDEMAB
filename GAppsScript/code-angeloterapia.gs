/**
 * UNIVERSAL SHEET TO JSON API (IDEMAB ANGELOTERAPIA)
 * 
 * Returns data for ALL sheets in the format: 
 * { 
 *   "Aula TV M1": [ {titulo: "...", link: "...", ...}, ... ],
 *   "Material M1": [ ... ]
 * }
 */
function doGet(e) {
    ...
    sheets.forEach(function (sheet) {
        ...
        // Optional: Skip specific system sheets if needed
        // if (sheetName === 'Config' || sheetName === 'Instructions') return;
        ...
        for (var i = 1; i < values.length; i++) {
            ...
            // MAPEO SEGÚN CAPTURA DE PANTALLA

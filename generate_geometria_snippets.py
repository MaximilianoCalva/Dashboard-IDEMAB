...
# Configuration
output_dir = "Dashboard/GeometriaSagrada"
modules = [f"M{i}" for i in range(1, 13)] # M1 to M12
api_placeholder = "https://script.google.com/macros/s/AKfycbybFyAD0ZlvtZBCGWnbOEpxcogxV3jHZfc21UiI3mF1Qw98scwKxMNlsc3TfPbpyWSW3w/exec"

# Ensure output directory exists
os.makedirs(output_dir, exist_ok=True)

# Templates with FUZZY MATCHING for Tab Names
template_aula = """
<!-- Snippet: Aula TV {module} - Geometria Sagrada -->
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="mb-12 border-l-4 border-purple-600 pl-6">
        ...
        <p class="text-lg text-gray-500 idemab-font-body">Geometría Sagrada</p>
    </div>
...
template_material = """
<!-- Snippet: Material {module} - Geometria Sagrada -->
<script src="https://cdn.tailwindcss.com"></script>
...
<div class="idemab-material max-w-7xl mx-auto p-4">
    <div class="text-center mb-8">
        ...
        <p class="text-gray-500 mt-1">Recursos del Módulo {module_num} (Geometría Sagrada)</p>
    </div>
...
for mod in modules:
    ...
    # Aula TV
    file_aula = f"{output_dir}/snippet-geometria-{mod.lower()}-aula-tv.html"
    ...
    # Material
    file_mat = f"{output_dir}/snippet-geometria-{mod.lower()}-material.html"
